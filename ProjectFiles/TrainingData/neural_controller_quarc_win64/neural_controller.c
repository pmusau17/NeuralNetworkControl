...
void neural_controller_output(void)
{
  ...
  /* Sin: '<Root>/Sine Wave' */
  neural_controller_B.SineWave = sin(neural_controller_P.SineWave_Freq *
    neural_controller_M->Timing.t[0] + neural_controller_P.SineWave_Phase) *
    neural_controller_P.SineWave_Amp + neural_controller_P.SineWave_Bias;
  ...
  rtb_netsum_g_idx_0 = neural_controller_P.IW111_Value *
    neural_controller_B.SineWave + neural_controller_P.b1_Value[0];
  rtb_netsum_g_idx_1 = neural_controller_P.IW112_Value *
    neural_controller_B.SineWave + neural_controller_P.b1_Value[1];
   ...
   *  Sum: '<S8>/netsum'
   */
  neural_controller_B.Addminx = (((((neural_controller_P.IW211_Value[0] *
    rtb_netsum_g_idx_0 + neural_controller_P.IW211_Value[1] * rtb_netsum_g_idx_1)
    + neural_controller_P.b2_Value[0]) * neural_controller_P.IW321_Value[0] +
    ((neural_controller_P.IW212_Value[0] * rtb_netsum_g_idx_0 +
      neural_controller_P.IW212_Value[1] * rtb_netsum_g_idx_1) +
...
void neural_controller_initialize(void)
{
  ...
  /* S-Function Block: neural_controller/HIL Initialize (hil_initialize_block) */
  {
    ...
    result = hil_set_card_specific_options
      (neural_controller_DW.HILInitialize_Card, " ", 2);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(neural_controller_M, _rt_error_message);
...
RT_MODEL_neural_controller_T *neural_controller(void)
{
  ...
  /* External mode info */
  neural_controller_M->Sizes.checksums[0] = (3238686255U);
  neural_controller_M->Sizes.checksums[1] = (757547561U);
  neural_controller_M->Sizes.checksums[2] = (143792423U);
  neural_controller_M->Sizes.checksums[3] = (982473909U);
  ...
  {
    neural_controller_B.SineWave = 0.0;
  ...
  neural_controller_M->Sizes.numBlockPrms = (112);/* Sum of parameter "widths" */
